**Vinci** in uno dei seguenti casi:
- Sei il 1° giocatore che **taglia la linea del traguardo** con una delle sue auto.
- Sei l'ultimo giocatore rimasto con **1+ auto operative** in gioco dopo che tutti gli altri sono stati **eliminati** (*vedere [stato delle auto]{.def}*).
