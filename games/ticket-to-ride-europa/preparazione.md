Posiziona il [tabellone]{.def} al centro del tavolo e ponici accanto la **carta Bonus European Express** e la **carta Riassuntiva**.

# Componenti per giocatore

Ogni giocatore prende:

- **45 [Vagoni]{.def}** del proprio colore
...
[Vagoni]: Pedine di plastica del proprio colore usate per occupare le caselle delle linee ferroviarie.

[Stazioni Ferroviarie]: Strutture che permettono di usare una linea avversaria in una città per completare i propri Biglietti Destinazione.

[carte Treno]: Carte colorate usate per prendere il controllo delle linee ferroviarie sul tabellone.

[carta Biglietto Destinazione]: Carta che indica due città da collegare per ottenere punti bonus (o subire penalità se non completata).
:::
