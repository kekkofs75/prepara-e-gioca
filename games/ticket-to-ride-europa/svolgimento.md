...
| Azione | Descrizione |
|--------|-------------|
| **Pescare carte Treno** | Pesca 2 carte Treno o 1 carta Locomotiva tra quelle a faccia in su, oppure pesca 2 carte Treno dal mazzo |
...
- Pesca **1 [carta Locomotiva]{.def}** tra le cinque a faccia in su. Rimpiazzala immediatamente con una nuova dal mazzo Treno.
- Pesca **2 carte Treno** (non Locomotiva) tra le cinque a faccia in su. Ad ogni carta pescata rimpiazzala immediatamente con una nuova dal mazzo Treno.
- Pesca **2 carte Treno** (alla cieca) dal mazzo Treno.
...
Quando il mazzo Treno si esaurisce, mescola (per bene) gli scarti e forma un nuovo mazzo. Se non ci sono carte Treno tra gli scarti non puoi eseguire questa azione.
...
Puoi pescare una Locomotiva tra quelle a faccia in su come prima ed unica carta di pesca, oppure puoi avere la fortuna di pescarne una o due tra le 2 pescate alla cieca.
...
Alcune città sono collegate da **[Doppia Linea]{.def}** con un pari numero di caselle parallele tra le due città adiacenti. Non puoi controllarle entrambe nella stessa partita.

> Se collegano città diverse, anche se per un tratto sono parallele, non sono Doppie Linee.

> In una partita a **2|3 giocatori** è possibile usare **solo una linea** delle Doppie Linee (l'altra diventa chiusa).
