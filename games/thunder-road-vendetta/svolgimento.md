...
- All'inizio di ogni round (eccetto il primo) tutti tirano i propri **4 dadi movimento** ![dado movimento](img/dado-movimento.png){.img-inline}.
- Il [primo giocatore]{.def} lancia anche il **dado strada** ![dado strada](img/dadofx-strada.png){.img-inline}.
...
Poni **1 [dado movimento]{.def}** ![dado movimento](img/dado-movimento.png){.img-inline} inutilizzato al **centro del cruscotto** di un'**auto operativa** (0–1 segnalini danno) che **non** hai ancora mosso nel round.
...
Se durante il movimento hai percorso **solo caselle strada**, al termine puoi usare il **dado strada** ![dado strada](img/dadofx-strada.png){.img-inline} per ottenere movimento aggiuntivo pari all'**intero** suo valore (non per forza sulla strada).
...
|   | Casella | Costo |
| :---: | :---: | :--- |
| ![casella strada](img/casella-strada.png){.img-inline} | **Strada** | 1 movimento per entrarci (consente il bonus dado strada) |
| ![casella fuori-strada](img/casella-fuori-strada.png){.img-inline} | **Fuori-strada** | 1 movimento per entrarci (nessun bonus) |
| ![casella fango](img/casella-fango.png){.img-inline} | **Fango** | 2 movimenti (o 1 rimasto) per entrarci |
| ![casella invalicabile](img/casella-invalicabile.png){.img-inline} | **Invalicabile** | l'auto viene eliminata (doppia linea gialla) |
| ![casella pericolo](img/casella-pericolo.png){.img-inline} | **Pericolo** | posizione per segnalino pericolo (se non ne contiene uno, non ha effetto; doppie linee rosse e triangolo) |
...
Se entri in una casella con un **segnalino pericolo** ![segnalino pericolo](img//segnalino-pericolo.png){.img-inline}, rivelalo (se coperto) e risolvilo. Alcuni vengono **scartati**, altri **rimangono** sul tabellone.
...
1. Lancia **1 dado tamponamento** ![dado tamponamento](img/dadofx-tamponamento.png){.img-inline} e **1 dado direzione** ![dado direzione](img/dadofx-direzione.png){.img-inline} per determinare quale veicolo si muove (in cima o in fondo) e in quale direzione.

|   | # | Veicolo |
| :---: | :---: | :--- |
| ![veicolo in cima](img/valore-tamponamento-cima.png){.img-inline} | **x2**{.accent} | Si muove il veicolo in cima |
| ![veicolo in fondo](img/valore-tamponamento-fondo.png){.img-inline} | **x4**{.accent} | Si muove il veicolo in fondo |

|   | # | Direzione |
| :---: | :---: | :--- |
| ![direzione dietro-sinistra](img/valore-direzione-dietrosinistra.png){.img-inline} | **x1**{.accent} | Dietro a sinistra |
| ![direzione dietro](img/valore-direzione-dietro.png){.img-inline} | **x1**{.accent} | Dietro |
| ![direzione dietro-destra](img/valore-direzione-dietrodestra.png){.img-inline} | **x3**{.accent} | Dietro a destra |
| ![direzione davanti-sinistra](img/valore-direzione-davantisinistra.png){.img-inline} | **x1**{.accent} | Dietro a sinistra |
| ![direzione davanti](img/valore-direzione-davanti.png){.img-inline} | **x1**{.accent} | Dietro |
| ![direzione davanti-destra](img/valore-direzione-davantidestra.png){.img-inline} | **x3**{.accent} | Dietro a destra |
...
Lancia 1 **dado mira** ![dado mira](img/dadofx-mira.png){.img-inline}: se la dimensione dell'auto bersaglio compare nel risultato, quel veicolo è colpito e riceve **danno**.

|   | # | Bersaglio |
| :---: | :---: | :--- |
| ![mira M-S](img/valore-mira-mediapiccola.png){.img-inline} | **x1**{.accent} | Veicolo su strada piccolo/medio |
| ![mira M](img/valore-mira-media.png){.img-inline} | **x1**{.accent} | Veicolo su strada medio |
| ![mira G](img/valore-mira-grande.png){.img-inline} | **x3**{.accent} | Veicolo su strada grande |
| ![mira S-M-L](img/valore-mira-qualsiasi.png){.img-inline} | **x1**{.accent} | Veicolo su strada di qualsiasi dimensione |
...
|   | Segnalino | Effetto |
| :---: | :---: | :--- |
| ![ammaccatura](img/danno-ammaccatura.png){.img-inline} | **Ammaccatura** | Nessun effetto aggiuntivo |
| ![schegge](img/danno-schegge.png){.img-inline} | **Schegge** | Lancia il dado direzione ![dado direzione](img/dadofx-direzione.png){.img-inline}; il primo veicolo su strada, se presente, in quella direzione riceve 1 danno (le schegge ignorano qualsiasi terreno, anche invalicabile) |
| ![slittamento](img/danno-slittamento.png){.img-inline} | **Slittamento** | Sposta l'auto di 1 casella nella direzione mostrata (6 varianti) |
| ![sbandata](img/danno-sbandata.png){.img-inline} | **Sbandata** | Lancia il dado acrobazia ![dado acrobazia](img/dadofx-acrobazia.png){.img-inline}; l'auto si muove di tante caselle lanciando il dado direzione ![dado direzione](img/dadofx-direzione.png){.img-inline} per ognuna (il terreno ha effetto come al solito; la sbandata termina se l'auto perde il movimento) |
| ![sbalzo](img/danno-sbalzo.png){.img-inline} | **Sbalzo** | Lancia il dado direzione ![dado direzione](img/dadofx-direzione.png){.img-inline} e il dado acrobazia ![dado acrobazia](img/dadofx-acrobazia.png){.img-inline}; l'auto si sposta di tante caselle in quella direzione ignorando tutto ciò che c'è in mezzo (la casella finale ha effetto come al solito) |
...
## Segnalini Comando
I **segnalini comando** ![segnalino comando](img/segnalino-comando.png){.img-inline} ti consentono di usare comandi aggiuntivi durante il round.
