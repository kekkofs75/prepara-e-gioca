Il livello termina non appena un giocatore completa un **[percorso valido]{.def}**.

## Condizioni di percorso valido

- Le tessere Percorso collegano nell'ordine esatto: **Porta → Chiave → Forziere → Mostro → Uscita**.
...
:::glossary
[percorso valido]: Un percorso che collega nell'ordine esatto Porta → Chiave → Forziere → Mostro → Uscita, rispettando tutte le condizioni speciali del livello (numero esatto di tessere, uso corretto di Ponti, nessuna Buca attraversata).
:::
