...
Mescola e poni **coperti** gli **11 [segnalini Congiura]{.def}** ![segnalino congiura](img/segnalino-congiura.png){.img-inline} in una pila accanto alla sua plancia Combattente.
...
Il **veleno** ![veleno](img/veleno.png){.img-inline} si attiva sempre **dopo** che sono state risolte tutte le altre azioni delle congiure. Il veleno influisce sui PF del combattente **dopo** ogni modifica ai PF delle congiure scatenate (dovuta ad attacchi, danni diretti, o i guadagni delle cure). Se ne **scateni 2+ nello stesso turn**o, ogni segnalino veleno si attiva sul nuovo totale di PF.

## Effetti dei Segnalini

| Icona | Effetto |
|---|---|
| ![segnalino congiura](img/congiura-01.png){.img-inline} | Scatena una congiura e attacca |
| ![segnalino congiura](img/congiura-02.png){.img-inline} | Attacca entrambi gli avversari |
| ![segnalino congiura](img/congiura-03.png){.img-inline} | Cura 6 PF al tuo partner |
| ![segnalino congiura](img/congiura-04.png){.img-inline} | TUTTI i combattenti subiscono 1 danno diretto |
| ![segnalino congiura](img/congiura-05.png){.img-inline} | Ottieni 2 cubetti Potere |
| ![segnalino congiura](img/congiura-06.png){.img-inline} | Il tuo partner ottiene 2 cubetti Potere |
| ![segnalino congiura](img/congiura-07.png){.img-inline} | Scatena una congiura e il tuo partner ottiene 1 cubetto Potere |
| ![segnalino congiura](img/congiura-08.png){.img-inline} | Tu e il tuo partern ottenete 1 cubetto Potere ciascuno |
| ![segnalino congiura](img/veleno.png){.img-inline} | Il tuo avversario subisce un ammontare di danni diretti pari alla metà dei suoi PF attuali (arrotondati per difetto). Per questo motivo, il veleno **non** può mettere KO un combattente. |
