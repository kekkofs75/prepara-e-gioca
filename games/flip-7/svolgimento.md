...
- **PESCARE (HIT)**{.accent}: riceve **1 carta** dal mazzo.
:::indent
Pone le **carte Numero** in fila davanti a sé, le **carte Azione e Modificatore** sopra di esse. Se pesca una **carta Numero** con un **valore già presente** nella sua fila **[SBALLA (BUST)]{.def}**, ovvero è **fuori dal round** e **non ottiene punti** (gira le proprie carte a faccia in giù).
:::
- **FERMARSI (STAY)**{.accent}: abbandona il round (solo se ha **1+ carte** davanti a sé).
:::indent
Mette al sicuro i **punti accumulati** e gira le proprie carte a faccia in giù.
:::
...
## Passaggio al Round Successivo o al Fine Partita
